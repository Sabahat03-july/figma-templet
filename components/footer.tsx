  ...
  return (
    <main className="bg-neutral-900">
      <div className="w-full sm:h-full lg:h-[350px] bg-neutral-900 flex justify-center items-center">
        <div className="w-full gap-y-9 pt-3 sm:pb-6 ftsapp,lex sm:flex-col lg:flex-row justify-evenly text-white px-4 sm:px-0">
      ...
      <p className="text-white text-center text-sm pb-4"><FontAwesomeIcon icon={faCopyright} className="text-lg mr-3" /> Copyright Rimel 2022. All rights reserved</p>
    </main>
  );
}
